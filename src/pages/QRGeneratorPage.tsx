...
const QRGeneratorPage: React.FC<QRGeneratorPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-emerald-50 to-emerald-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              ...
              >
                <ArrowLeft className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors" />
                ...
                <div className="mt-6 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-xl hover:bg-emerald-200 dark:hover:bg-emerald-800 transition-colors font-medium"
                    >
                      Create New QR
                    </button>
                  </div>
